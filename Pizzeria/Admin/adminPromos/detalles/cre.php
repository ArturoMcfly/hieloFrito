<?php
    ...
    $consulta="INSERT INTO `agregados_promociones`(`nombre_agregado_promo`, `precio_agregado_promo`, `caracteristicas_agregado_promo`,`id_promociones`) VALUES ('$nombre','$precio','$caracteristicas','$id')";
