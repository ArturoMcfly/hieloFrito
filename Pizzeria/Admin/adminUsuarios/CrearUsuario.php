                                  ...
                                  <div class="card-body">
                                    ...
                                    <form class="form-signin" action="crear.php" method="post">
                                      ...
                                      <div class="form-label-group">
                                        ...
                                        <input type="password" id="inputContrasenia" name="contrasenia" class="form-control" placeholder="Contraseña" required>
                                        <label for="inputContrasenia">Contraseña</label>
                                      </div>
                                      <div class="form-label-group">
                                          
                                      <input type="number" id="inputNumero" name="numero"class="form-control" placeholder="No." required>
