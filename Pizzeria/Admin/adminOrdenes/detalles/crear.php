            ...
            <div id="layoutSidenav_content">
                <main >
                    <div class="container-fluid">
                        <h1 style="color: white;" class="mt-4"> Administrar Ordenes</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Qué orden nueva tendremos?</li>
                        </ol>
                        <div class="">
                            <div class="">
                              <div class="">
