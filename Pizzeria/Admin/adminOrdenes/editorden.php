        ...
        <div id="layoutSidenav">
            ...
            <?php
                ...
                if($resultado->num_rows > 0){
                    ...
                    $total=$fila['total'];
                    $fecha_solicitud=$fila['fecha_hora_solicitud'];
                    $fecha_llegada=$fila['fecha_hora_llegada'];
                            ...
                            <div class="">
                              <div class="">
                                <div class="card card-signin my-5">
                                  <div class="card-body">
                                    <h5 class="card-title text-center">Modifique la Orden</h5>
                                    <form class="form-signin" action="edi1.php" method="post">
                                      
                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='number' id='inputId' name='id' class='form-control' placeholder='Id usuario' value='$id' required autofocus>"; 
                                          ?>
                                      ...
                                      <div class="form-label-group">
                                        <?php
                                            echo "<input type='text' id='inputTelefono' name='telefono' class='form-control' placeholder='Telefono' value='$telefono' required autofocus>"; 
                                        ?>
                                      ...
                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='text' id='inputDireccion' name='direccion' class='form-control' placeholder='Direccion' value='$direccion' required autofocus>"; 
                                          ?>
                                        <!--<input type="number" id="inputId" name="id" class="form-control" placeholder="ID" required>-->
                                      ...
                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='text' id='inputTotal' name='total' class='form-control' placeholder='Total' value='$total' required autofocus>"; 
                                          ?>
                                        <!--<input type="number" id="inputId" name="id" class="form-control" placeholder="ID" required>-->
                                      ...
                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='text' id='inputFecha_hora_solicitud' name='fecha_solicitud' class='form-control' placeholder='Fecha Salida' value=' $fecha_solicitud' required autofocus>"; 
                                          ?>
                                        <!--<input type="number" id="inputId" name="id" class="form-control" placeholder="ID" required>-->
                                        <label for="inputFecha_hora_solicitud">Hora de Solicitud</label>
                                      </div>

                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='text' id='inputFecha_hora_llegada' name='fecha_llegada' class='form-control' placeholder='Fecha Llegada' value='$fecha_llegada' required autofocus>"; 
                                          ?>
                                        <!--<input type="number" id="inputId" name="id" class="form-control" placeholder="ID" required>-->
                                        <label for="inputFecha_hora_llegada">Hora de Llegada</label>
                                      </div>
