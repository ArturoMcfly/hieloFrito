  ...
  .form-label-group input:-ms-input-placeholder {
    ...
    <body style="background: linear-gradient(to right, #6b6b6b, #612103);" class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <?php
                $query="SELECT * FROM agregados_bebidas WHERE id_agregado_bebidas=$id_detalle";
                $resultado=$mysqli->query($query);
                if($resultado->num_rows > 0){
                    $fila=$resultado->fetch_assoc();
                    $id_pizza=$fila['id_agregado_bebidas'];
                    $nombre=$fila['nombre_agregado_bebida'];
                    $precio=$fila['precio_agregado_bebida'];
                    $caracteristicas=$fila['caracteristica_agregado_bebida'];
            ?>
            <!-- Parte del centro -->
            <div id="layoutSidenav_content">
                <main >
                    <div class="container-fluid">
                        <h1 style="color: white;" class="mt-4"> Administrar Bebidas</h1>
                            ...
                            <div class="">
                              <div class="">
                                <div class="card card-signin my-5">
                                  <div class="card-body">
                                    <h5 class="card-title text-center">Modifique el complemento extra</h5>
