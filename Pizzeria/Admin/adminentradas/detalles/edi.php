<?php
    ...
    $consulta="UPDATE `agregados_entradas` SET `nombre_agregado_entrada` = '$nombre', `precio_agregado_entrada`='$precio', `caracteristica_agregado_entrada`='$caracteristica' WHERE `id_agregado_entradas` = $id_detalle";
