  ...
  .form-label-group input:-ms-input-placeholder {
    ...
    <body style="background: linear-gradient(to right, #6b6b6b, #612103);" class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <?php
                $query="SELECT * FROM postres WHERE id_postre=$id";
            ...
            <div id="layoutSidenav_content">
                <main >
                    <div class="container-fluid">
                        <h1 style="color: white;" class="mt-4"> Administrar Postres</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Qué postre nueva tendremos?</li>
                        </ol>
                        <div class="">
                            <div class="">
                              <div class="">
                                <div class="card card-signin my-5">
                                  <div class="card-body">
                                    <h5 class="card-title text-center">Modifique el postre</h5>
                                    <form class="form-signin" action="edi.php" method="post">
                                      
                                      <div class="form-label-group">
                                          <?php
                                            echo "<input type='number' id='inputId' name='id' class='form-control' placeholder='Id usuario' value='$id_postre' required autofocus>"; 
                                          ?>
