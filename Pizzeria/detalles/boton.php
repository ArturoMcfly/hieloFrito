...
$boton=$_POST['boton'];
    ...
    if($boton=="Calcular costo"){
        ...
        if($_POST['tipo']=="tradicional"){
            ...
            header("Location: calc.php?id_compra=$id_pizza_compra&&cantidad_compra=$cantidad_compra&&total_compra=$total_agregar&&tipo=tradicional");
        }else{
            $id_pizza_compra=$_POST['id_pizza_agregar'];
            ...
            header("Location: calc.php?id_compra=$id_pizza_compra&&id_detalle=$id_detalle_compra&&cantidad_compra=$cantidad_compra&&total_compra=$total_agregar&&tipo=personalizada");
        }
